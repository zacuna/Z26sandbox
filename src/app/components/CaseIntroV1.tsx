...
export function CaseIntroV1() {
  ...
  return (
    <section className="min-h-screen bg-zinc-950 relative overflow-hidden">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-16 md:-mt-32 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            >
              {metrics.map((metric, index) => (
                <div key={index}>
                  <p className="text-2xl md:text-4xl font-bold text-white mb-2">{metric.value}</p>
                  <p className="text-zinc-400 text-xs md:text-sm">{metric.label}</p>
                </div>
              ))}
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 mt-12 lg:mt-0">
            <motion.div
              ...
              className="grid grid-cols-2 lg:grid-cols-1 gap-6 lg:gap-8"
            >
              <div>
                <p className="text-zinc-500 text-xs tracking-wider mb-2">ROLE</p>
                <p className="text-white text-sm md:text-base">Lead Product Designer</p>
              </div>
              <div>
                <p className="text-zinc-500 text-xs tracking-wider mb-2">TIMELINE</p>
                <p className="text-white text-sm md:text-base">8 months (Jan–Aug 2024)</p>
              </div>
              <div>
                <p className="text-zinc-500 text-xs tracking-wider mb-2">TEAM</p>
                <p className="text-white text-sm md:text-base">2 Designers, 4 Engineers, 1 PM</p>
              </div>
              <div>
                <p className="text-zinc-500 text-xs tracking-wider mb-2">PLATFORM</p>
                <p className="text-white text-sm md:text-base">Web Application (Desktop)</p>
              </div>
            </motion.div>
          </div>
        </div>
